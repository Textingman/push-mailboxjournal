      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12" style={{ border: '1px solid #E5E7EB' }}>
          {submitStatus === 'success' ? (
            ...
            <>
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-2" style={{ color: '#1F2937' }}>Connect with Your The Mailbox Journal</h2>
                  ...
                  <div className="rounded-lg p-6 text-white" style={{ backgroundColor: '#1F2937' }}>
                    <div className="flex items-start">
                      ...
                      <label htmlFor="sms-account-notifications" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive transactional account notification text messages from The Mailbox Journal. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@themailboxjournal.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by The Mailbox Journal.
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg p-6 text-white" style={{ backgroundColor: '#1F2937' }}>
                    <div className="flex items-start">
                      ...
                      <label htmlFor="sms-customer-care" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive <strong>customer care</strong> text messages from The Mailbox Journal. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@themailboxjournal.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by The Mailbox Journal.
                      </label>
                    </div>
                  </div>
